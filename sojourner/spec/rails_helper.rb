...
RSpec.configure do |config|
  # Using databse cleaner instead since it truncates the database before running
  # the suite, which is helpful when linting factories
  ...
  config.after(:suite) do
    FileUtils.remove_dir('tmp/templates') if File.directory?('tmp/templates')
  end
